% E158_tissue_raw data processing
%% Load Tcond
%clear
parentDir='/Users/iandardani/Dropbox (RajLab)/Shared_IanD/clamp2/paper';
Tcond=readtable(fullfile(parentDir,'experiments/E158_tissue_Tcond.xlsx'));
Tcond.Nd2_dir=replace(Tcond.Nd2_dir,"/Volumes/IAND_04/","/Users/iandardani/Dropbox (RajLab)/Shared_IanD/clamp2/rawData/");

opts = detectImportOptions(fullfile(parentDir,'experiments/E158_tissue_Tscan.xlsx')); opts = setvartype(opts,{'condIDs'},{'char'});
Tscan=readtable(fullfile(parentDir,'experiments/E158_tissue_Tscan.xlsx'),opts);

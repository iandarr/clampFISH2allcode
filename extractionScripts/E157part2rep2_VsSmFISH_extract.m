...
parentDir='/Volumes/IAND_07'; % data parent Dir
cd(parentDir)
condList=[1,2,3];
%% Segmentation
%navigate to a subfolder and run this. Segment cells.
% do this for 60X
%cd(Tcond.Tiff_60X_dir{1})
...
cd(parentDir)
parentDirExtractedData='/Users/iandardani/Dropbox (RajLab)/Shared_IanD/clamp2';
%condList=[14]
...
destinationMagnificationList={'20X','10X'};
%destinationMagnificationList={'20X'};
%destinationMagnificationList={'10X'};
...
% rowToCompare=rowsWithDestinationSegmentation(end); % 1 for first or end for last
...
% % Read in table of conditions (Tcond)
Tcond=readtable(fullfile([parentDirExtractedData,filesep,'paper/experiments/E157part2rep2_VsSmFISH_Tcond.xlsx']));

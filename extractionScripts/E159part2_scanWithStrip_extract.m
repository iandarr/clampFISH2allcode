...
% for:
%   scanID=7 (part of well A1, drug-naive cells,     with extra imaging rounds), and
%   scanID=8 (part of well B3, drug-resistant cells, with extra imaging rounds) 
% 
% run this after the raw data processing script E159part2_scan_raw.m
%
...
extractedDataDir=fullfile(parentDir,'paper/extractedData/E159part2_scan/scan7_withStripAndRepeatData',filesep);
cd(parentDir)
%scanIDsList=[7,8]';
scanIDsList=7;
Tchannels=readtable(fullfile(parentDir,'paper/experiments/E159part2_scanWithStrip_ChannelDesc.xlsx'))
preStitchedScanFilelist=join([Tchannels.channelName(Tchannels.useChannel),repmat({'.tif'},sum(Tchannels.useChannel),1)],'',2)';
channelTypes=Tchannels.channelType(Tchannels.useChannel)';
thresholds=Tchannels.procThresh(strcmp(Tchannels.channelType,'FISH'))';
assert(all(~isnan(thresholds)))
...
for iSubregion=1:numSubregion
    ...
    segmentationImg=imread('Merged_Rcyto_YFP_DAPI_cp_masks.tif');
...
for iSubregion=1:numSubregion
    ...
    fishChannels={'R1_A594_250ms_DDX58'	'R1_CY3_1000ms_WNT5A'	'R1_CY5_250ms_AXL'	'R1_YFP_100ms_UBC'	'R1rep_A594_250ms_DDX58'	'R1rep_CY3_1000ms_WNT5A'	'R1rep_CY5_250ms_AXL'	'R1rep_YFP_100ms_UBC'	'R1s_A594_250ms'	'R1s_A594_500ms'	'R1s_CY3_1000ms'	'R1s_CY3_250ms'	'R1s_CY5_100ms'	'R1s_CY5_250ms'	'R1s_YFP_100ms'	'R2_A594_500ms_FN1'	'R2_CY3_250ms_NGFR'	'R2_CY5_100ms_EGFR'	'R2_YFP_100ms_UBC'	'R2s_A594_250ms'	'R2s_A594_500ms'	'R2s_CY3_250ms'	'R2s_CY5_100ms'	'R2s_YFP_100ms'	'R3_A594_250ms_MMP1'	'R3_CY3_250ms_ITGA3'	'R3_CY5_100ms_MITF'	'R3_YFP_100ms_UBC'	'R3s_A594_250ms'	'R3s_CY3_1000ms'	'R3s_CY3_250ms'	'R3s_CY5_100ms'	'R3s_CY5_250ms'	'R3s_YFP_100ms'	'R4_A594_250ms_DDX58'	'R4_CY3_1000ms_WNT5A'	'R4_CY5_250ms_AXL'	'R4_YFP_100ms_UBC'	'R5_A594_250ms_DDX58'	'R5_CY3_1000ms_WNT5A'	'R5_CY5_250ms_AXL'	'R5_YFP_100ms_UBC'};
    ...
    % it in
    numSegs=max(imread('Merged_Rcyto_YFP_DAPI_cp_masks.tif'),[],'all');
...
% only considering these readout cycles ('rounds'): R1, R1rep, R4, and R5
...
Tsr=groupsummary(TcellAll(:,{'uniqueSubregionInd','subregionInd','subregionRow','subregionCol','scanID','R1_YFP_100ms_UBC','R1rep_YFP_100ms_UBC','R4_YFP_100ms_UBC','R5_YFP_100ms_UBC'}),'uniqueSubregionInd','mean');
...
Tsr.passSubregion=all([Tsr.mean_R1_YFP_100ms_UBC,Tsr.mean_R1rep_YFP_100ms_UBC,Tsr.mean_R4_YFP_100ms_UBC,Tsr.mean_R5_YFP_100ms_UBC]>=subregionMinMeanUBC,2);
TcellAll=join(TcellAll,Tsr(:,{'uniqueSubregionInd','passSubregion'}));

% QC criteria 2: For all 4 rounds, UBC count >= minUBC
...
UBC4Rounds=TcellAll{:,{'R1_YFP_100ms_UBC','R1rep_YFP_100ms_UBC','R4_YFP_100ms_UBC','R5_YFP_100ms_UBC'}};

minUBC=4; % per cell;
passMinUBC=all(UBC4Rounds>=minUBC,2);
...
passMinUBCPerArea = min(UBC4Rounds,[],2)>= minUBCPerUm2 * TcellAll.Area_Um2;
...
passPctUBC=all((100 * abs(UBC4Rounds./median(UBC4Rounds,2) - 1)) <= minPcrErrUBC,2);

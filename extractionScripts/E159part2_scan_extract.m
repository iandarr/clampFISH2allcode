...
for iSubregion=1:numSubregion
    ...
    temp=split(scanDir,'/'); scanDirRel=temp{end};
    %outPath=fullfile('/Users/iandardani/Dropbox (RajLab)/Shared_IanD/clamp2/rawData/E159part2_scan/scan/',scanDirRel,'SubregionArray6x6/',filesep,subregionDir,filesep,'spotTableAboveThreshIgnoringValidity.csv');
    %writetable(spotTableAboveThreshIgnoringValidity,outPath);

...
% for:
%   scanID=3 (part of well A1, drug-naive cells,     with extra imaging rounds), and
%   not running this for scanID=4 (part of well B3, drug-resistant cells, with extra imaging rounds), not going to use
% 
...
extractedDataDir=fullfile(parentDir,'paper/extractedData/E159part2rep2_scan/scan3_withStripAndRepeatData',filesep);
cd(parentDir)
%scanIDsList=[7,8]';
scanIDsList=3;
...
Tsr.passSubregion=all([Tsr.mean_R1_YFP_100ms_UBC,Tsr.mean_R1rep_YFP_100ms_UBC,Tsr.mean_R4_YFP_100ms_UBC]>=subregionMinMeanUBC,2);
...
UBC3Rounds=TcellAll{:,{'R1_YFP_100ms_UBC','R1rep_YFP_100ms_UBC','R4_YFP_100ms_UBC'}};

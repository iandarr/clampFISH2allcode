% E166_smFISH_onepot_100X_extract
% based on E159part1rep2_ampOverRounds_100X_extract
% 
% 
% 1. determine the spot sizes of smFISH vs. clampISH 2.0 (at Round 1 & 4)
% 2. show one-pot amp did not go above clampFISH 2.0 round 1 levels

Tcond=readtable('/Users/iandardani/Dropbox (RajLab)/Shared_IanD/clamp2/paper/experiments/E166_smFISH_onepot_100X_Tcond.xlsx');
parentDir='/Volumes/IAND_10';
parentDirForExtractedData='/Users/iandardani/Dropbox (RajLab)/Shared_IanD/clamp2/';
extractedDataDirAllConditions='paper/extractedData/E166_smFISH_onepot_100X';
...
% condID=1 is smFISH
condList=[2;3;4;5]; % set uniform threshold for clamp2 
%condList=[6];
cd(parentDir)
...
%     channelsToExtract=channelNamesAll(idx);
    ...
    if ismember(condID,1)
        channelsToExtract={'gfp','cy'};
    else
        channelsToExtract={'cyb'};
    end

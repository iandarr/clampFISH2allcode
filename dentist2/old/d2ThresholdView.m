classdef d2ThresholdView < matlab.apps.AppBase
    ...
    methods
        ...
        function createComponents(app)
            ...
            app.threshAxes = uiaxes(app.figHandle, 'XTickLabel', '', 'YTickLabel', '', 'Position', [549 1 331 210]);
            app.thumbAxes = uiaxes(app.figHandle, 'XTickLabel', '', 'YTickLabel', '', 'Position', [549 361 190 190]);
            
            app.centroidList = uilistbox(app.figHandle, 'Position', [758 381 115 151]);
            app.channelPopup = uidropdown(app.figHandle, 'Items', app.spotTable.spotChannels, 'Position', [561 304 100 22]);          
            ...
            app.maskSpotsButton = uibutton(app.figHandle, 'push', 'Text', 'mask spots', 'Position', [561 214 100 22]);
            ...
            app.zoomInAxes = uibutton(app.figHandle, 'push', 'Text', 'zoom in', 'Position', [561 274 100 22]);
            app.zoomOutAxes = uibutton(app.figHandle, 'push', 'Text', 'zoom out', 'Position', [561 244 100 22]);
            ...
            app.zoomInThresh = uibutton(app.figHandle, 'push', 'Text', 'zoom in', 'Position', [810 170 63 20]);
            app.zoomOutThresh = uibutton(app.figHandle, 'push', 'Text', 'zoom out', 'Position', [810 146 63 20]);
            app.resetThresh = uibutton(app.figHandle, 'push', 'Text', 'reset', 'Position', [744 146 63 20]);
            app.threshValue = uieditfield(app.figHandle, 'numeric', 'RoundFractionalValues', 'on', 'HorizontalAlignment', 'center', 'Position', [744 170 63 20]);
            ...
            app.figHandle.Visible = 'on';
        end
        
        %attach controller
        function startupFcn(app)
            app.controlObj = d2ThresholdController(app, app.scanObj, app.spotTable, app.maskObj, app.nucleiObj);  
        ...
        function attatchToController(app, controller)
            ...
            addlistener(app.centroidList,'ValueChanged',@controller.changeChannel) 
            
            addlistener(app.channelPopup,'ValueChanged',funcH) 
            ...
            addlistener(app.threshValue,'ValueChanged',funcH)
        end

...
function [foundChannels,fileNums,imgExts] = getImageFiles(dirPath,numFilter)
    ...
    %channels = {'gfp','gfpa','gfpb','gfpc','gfpd','gfpe','tmr','tmra','tmrb','tmrc','tmrd','tmre','alexa','alexaa','alexab','alexac','alexad','alexae','cy','cya','cyb','cyc','cyd','cye','nir'};
    %channels = {'alexa','cy','gfp','nir','tmr','alexaa','alexab','alexac','tmra','tmrb','tmrc','cya','cyb','cyc','cyd'};
    channels={'alexa','cy','gfp','gfpa','gfpb','nir','tmr','alexaa','alexab','alexac','tmra','tmrb','tmrc','cya','cyb','cyc','cyd',...
            'R1_CY3_250ms_NGFR'	'R1_A594_250ms_MMP1'	'R1_CY5_250ms_AXL'	'R1_CY3_250ms_ITGA3'	'R1_A594_500ms_FN1'	'R1_CY5_100ms_EGFR'	'R1_CY3_500ms_WNT5A'	'R1_A594_500ms_DDX58'	'R1_CY5_100ms_MITF'	'R1_YFP_100ms_UBC',...
            'R1s_CY3_250ms_NGFR'	'R1s_A594_250ms_MMP1'	'R1s_CY5_250ms_AXL'	'R1s_CY3_250ms_ITGA3'	'R1s_A594_500ms_FN1'	'R1s_CY5_100ms_EGFR'	'R1s_CY3_500ms_WNT5A'	'R1s_A594_500ms_DDX58'	'R1s_CY5_100ms_MITF'	'R1s_YFP_100ms_UBC'};

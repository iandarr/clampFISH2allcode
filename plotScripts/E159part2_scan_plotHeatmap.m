...
extractedDataDir=fullfile(parentDir,'paper/extractedData/E159part2_scan',filesep);
plotDir=fullfile(parentDir,filesep,'paper/plots/scan',filesep);
...
outdataFile='SourceData_Fig3.xlsx';
outdataSheet='SourceData_Fig3';

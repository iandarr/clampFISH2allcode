% E159part2rep2_scan_readoutRehyb_plot
...
extractedDataDir=fullfile(parentDir,'paper/extractedData/E159part2rep2_scan/scan3_withStripAndRepeatData/');
plotDir=fullfile(parentDir,filesep,'paper/plots/E159part2rep2_scan_readoutRehyb/');

cd(parentDir)

% import Tcell (for drug-naive cells)
Tcell=readtable(fullfile(extractedDataDir,'TcellAll2.csv'));
TplotsAll=readtable(fullfile(plotDir,filesep,'E159part2rep2_scan_readoutRehyb_Tplots.xlsx'));

% for simple plot data output
dirForDataExport=fullfile(parentDir,filesep,'paper/plotsDataSimple',filesep);
outdataFile='SupFig15_rehybRep2.xlsx';
outdataSheet='SupFig15_rehybRep2';
...
missingDataVariables={'R5_CY3_1000ms_WNT5A','R5_CY5_250ms_AXL','R5_YFP_100ms_UBC'};
assert(all(Tcell{:,missingDataVariables}==0,'all'))
Tcell{:,missingDataVariables}=nan(height(Tcell),length(missingDataVariables));

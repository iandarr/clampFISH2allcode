...
cd(parentDir)
Tcond=readtable('paper/experiments/E159part1rep2_ampclick_Tcond.xlsx');
% Import Data
cd(parentDir)
extractedDataDirForAllCond='paper/extractedData/E159part1rep2_ampclick/';
plotDir=['paper/plots/E159part1rep2_amplification_and_click'];
